...
using f_cell_props_t = struct f_cell_props;
using f_cell_prop_container_t = f_vector_t;

FT_INTERNAL
auto create_cell_prop_container() -> f_cell_prop_container_t *;

FT_INTERNAL
void destroy_cell_prop_container(f_cell_prop_container_t *cont);

FT_INTERNAL
auto cget_cell_prop(const f_cell_prop_container_t *cont, size_t row, size_t col) -> const f_cell_props_t *;

FT_INTERNAL
auto get_cell_prop_and_create_if_not_exists(f_cell_prop_container_t *cont, size_t row, size_t col) -> f_cell_props_t *;

FT_INTERNAL
auto set_cell_property(f_cell_prop_container_t *cont, size_t row, size_t col, uint32_t property, int value) -> f_status;

FT_INTERNAL
auto get_cell_property_hierarchically(const f_table_properties_t *properties, size_t row, size_t column,
                                      uint32_t property) -> int;

FT_INTERNAL
auto set_default_cell_property(uint32_t property, int value) -> f_status;
...
using fort_entire_table_properties_t = struct fort_entire_table_properties;
extern fort_entire_table_properties_t g_entire_table_properties;

FT_INTERNAL
auto set_entire_table_property(f_table_properties_t *table_properties, uint32_t property, int value) -> f_status;

FT_INTERNAL
auto set_default_entire_table_property(uint32_t property, int value) -> f_status;
...
FT_INTERNAL
auto max_border_elem_strlen(struct f_table_properties *) -> size_t;

FT_INTERNAL
auto create_table_properties() -> f_table_properties_t *;

FT_INTERNAL
void destroy_table_properties(f_table_properties_t *properties);

FT_INTERNAL
auto copy_table_properties(const f_table_properties_t *property) -> f_table_properties_t *;
