...
auto main() -> int {
  ...
  table << fort::header << "Тест" << "Итерации" << "ms/op" << "Тики" << "Результат" << fort::endr << "n-body" << "1000"
        << "1.6" << "1,500,000" << "✔" << fort::endr << fort::separator << "regex-redux" << "1000" << "0.8"
        << "8,000,000" << fort::endr << "" << "2500" << "3.9" << "27,000,000" << "✖" << fort::endr << "" << "10000"
        << "12.5" << "96,800,000" << fort::endr << fort::separator << "mandelbrot" << "1000" << "8.1" << "89,000,000"
        << fort::endr << "" << "2500" << "19.8" << "320,000,000" << "✔" << fort::endr << "" << "10000" << "60.7"
        << "987,000,000" << fort::endr << fort::separator << "Итог" << "" << "" << "" << "✖" << fort::endr;
