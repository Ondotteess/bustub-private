...
void test_cpp_bug_fixes() {
  SCENARIO("Issue 11 - https://github.com/seleznevae/libfort/issues/11") {
    ...
    table << fort::header << "1" << "2" << fort::endr << "3" << "4" << fort::endr;
  ...
  SCENARIO("Issue 37 - https://github.com/seleznevae/libfort/issues/37") {
    ...
    table << fort::header << "hdr1" << "hdr2" << "xxx" << fort::endr << "3" << ""
          << "||||||||||||||||||||||||||||||\n"
             "||||||||||||||||||||||||||||||\n"
             "||||||||||||||||||||||||||||||\n"
             "||||||||||||||||||||||||||||||\n"
  ...
  SCENARIO("Issue 49 - https://github.com/seleznevae/libfort/issues/49") {
    fort::char_table table;
    table << std::setprecision(5) << 3.14 << std::hex << 256 << fort::endr << std::fixed << std::setprecision(2)
          << 11.1234567;
    std::string table_str = table.to_string();
    std::string table_str_etalon =
        "+-------+-----+\n"
...
void test_cpp_table_basic() {
  ...
  WHEN("All columns are equal and not empty.") {
    ...
    table << fort::header << "3" << "c" << "234" << "3.140000" << fort::endr << "3" << "c" << "234" << "3.140000"
          << fort::endr << "3" << "c" << "234" << "3.140000" << fort::endr;
  ...
  WHEN("All columns are not equal and not empty") {
    ...
    table << fort::header << "3" << "c" << "234" << "3.140000" << fort::endr << "c" << "234" << "3.140000" << "3"
          << fort::endr << "234" << "3.140000" << "3" << "c" << fort::endr;
  ...
  WHEN("All columns are not equal and some cells are empty") {
    ...
    table << fort::header << "" << "" << "234" << "3.140000" << fort::endr << "c" << "234" << "3.140000" << ""
          << fort::endr << "234" << "3.140000" << "" << "" << fort::endr;
  ...
  WHEN("All cells are empty") {
    ...
    table << fort::header << "" << "" << "" << "" << fort::endr << "" << "" << "" << "" << fort::endr << "" << "" << ""
          << "" << fort::endr;
...
void test_cpp_table_insert() {
  SCENARIO("Test insert into beginning") {
    ...
    table << "val1" << "val2" << fort::endr << "val3" << "val4" << fort::endr;
  ...
  SCENARIO("Test insert into the middle") {
    ...
    table.set_adding_strategy(fort::add_strategy::insert);
    table.set_border_style(FT_BOLD_STYLE);
    table << fort::header << "hdr1" << "hdr2" << fort::endr << "val1" << "val4" << fort::endr;
