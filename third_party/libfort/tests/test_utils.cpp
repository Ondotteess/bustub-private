...
auto set_cpp_test_props_for_table(fort::char_table *table) -> bool {
...
auto create_cpp_test_int_table(int set_test_opts) -> fort::char_table {
...
auto set_test_properties_as_default() -> int {
  bool status = true;
