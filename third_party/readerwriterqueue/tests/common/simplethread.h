...
class SimpleThread {
 ...
 public:
  ...
  explicit SimpleThread(TCallback &&callback) {
    auto wrapper = new CallbackWrapper<TCallback, details::ArgWrapper<>>(std::forward<TCallback>(callback),
                                                                         details::ArgWrapper<>());
  ...
  explicit SimpleThread(TCallback &&callback, TArg1 &&arg1, TArg2 &&arg2, TArg3 &&arg3) {
    auto wrapper = new CallbackWrapper<TCallback, details::ArgWrapper<TArg1, TArg2, TArg3>>(
        std::forward<TCallback>(callback),
        details::ArgWrapper<TArg1, TArg2, TArg3>(std::forward<TArg1>(arg1), std::forward<TArg2>(arg2),
